   ...
   public class DrupalService extends NetConnection
   {
      ...
      private function setupCommands()
      {
         var hasKey:Boolean = false;
			...
			var usesKey:Boolean = (Params.flashVars.api == 1);
			
         commands = new Object();
         commands[Service.SYSTEM_CONNECT] = {command:"system.connect", useKey:usesKey};
         commands[Service.SYSTEM_MAIL] = {command:"system.mail", useKey:hasKey};
         commands[Service.NODE_LOAD] = {command:"node.load", useKey:(usesKey || (Params.flashVars.api >= 3))};			
         commands[Service.GET_VERSION] = {command:"dashplayer.getDrupalVersion", useKey:usesKey};			
         commands[Service.GET_VIEW] = {command:"dashplayer.getView", useKey:usesKey};			
         commands[Service.GET_VOTE] = {command:"vote.getVote", useKey:usesKey};			
         commands[Service.SET_VOTE] = {command:"vote.setVote", useKey:hasKey};			
         commands[Service.GET_USER_VOTE] = {command:"vote.getUserVote", useKey:usesKey};			
         ...
         commands[Service.IS_FAVORITE] = {command:"favorites.isFavorite", useKey:usesKey};			
         ...
         commands[Service.GET_AD] = {command:"dashplayer.getAd", useKey:usesKey}; 
      ...
      private function getCommand( _command:String ) : Object
      {
         ...
         return {command:_command, useKey:(Params.flashVars.api == 1)};
      }
